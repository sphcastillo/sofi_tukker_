      ...
      >
        ...
        <motion.div
          ...
          className={`flex justify-center transition-all duration-300 ${
            isScrolled
              ? "w-[96px] xxs:w-[130px] xs:w-[160px] sm:w-[134px] md:w-[170px] lg:w-[240px] "
              : "w-[115px] xxs:w-[140px] xs:w-[175px] sm:w-[216px] md:w-[240px] lg:w-[280px] lgPlus:w-[295px] xlPlus:w-[320px]"
          }`}
        >
