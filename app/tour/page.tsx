...
const tourDates = [
  ...
  // { date: "DEC 11, 2024", venue: "THE 02", city: "LONDON, UK", VIP: false, tickets: true },
  // { date: "DEC 12, 2024", venue: "NIGHT TALES (DJ SET)", city: "LONDON, UK", VIP: false, tickets: false },
  // { date: "DEC 13, 2024", venue: "3ARENA", city: "DUBLIN, IRELAND", VIP: false, tickets: true },
  { date: 'FEB 22, 2025', venue: 'PALM TREE MUSIC FESTIVAL ASPEN (DJ SET)', city: 'ASPEN, CO', VIP: false, tickets: true },
  { date: 'MAR 26, 2025 - MAR 30, 2025', venue: 'TREEFORT MUSIC FEST (DJ SET)', city: 'BOISE, ID', VIP: false, tickets: true },
  { date: 'JUL 16, 2025 - JUL 19, 2025', venue: 'COLOURS OF OSTRAVA', city: 'OSTRAVA, MORAVIAN-SILESIAN REGION', VIP: false, tickets: true },
];
    ...
    <div className="pt-12 pb-5 bg-[#b9ddba]">
      ...
      {tourDates.map((tour, index) => (
        <div key={index} className="grid grid-cols-3 gap-4 items-center bg-[#b9ddba] p-1 xxs:p-2 xs:p-4 md:px-12 lg:px-[120px] rounded-lg mb-4 hover:bg-[#fa264e] transition-colors duration-300">
          ...
          {tour.tickets ? (
            <button className={`${franklinGothicCondensed.className} w-full ${
